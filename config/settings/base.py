...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://localhost/osef",
    ),
}
...
MIGRATION_MODULES = {"sites": "osef.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "osef.utils.middleware.AppendSlash",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "osef.apps.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# Désactivé pour éviter les problème avec VueJs
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "osef.apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "osef.apps.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "osef.apps.users.apps.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "osef.apps.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "OSEF API",
    "DESCRIPTION": "Documentation of API endpoints of OSEF",
    "VERSION": "1.0.0",
